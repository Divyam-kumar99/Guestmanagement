        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url().'Admin/reception/index';?>">Home</a></li>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            ...
            <form action="<?= base_url().'admin/reception/profile/'.$arr['id'];?>" name="newadmin" id="newadmin" method="post" enctype="multipart/form-data">
              <div class="card-body">
              ...
              <div class="form-row">
                ...
                <div class="form-group">
                  <a href="<?= base_url().'Admin/reception/index';?>" class="btn btn-secondary py-1 px-3">Back</a>
                </div>
              </div>
