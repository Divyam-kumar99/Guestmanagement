            ...
            <div class="card">
              <div class="card-header bg bg-primary">Visitors Details
                  <div class="card-tools">
                    <a href="<?= base_url().'admin/Admin/mymeeting/'.$id;?>" class="btn btn-secondary px-3"><i class="far fa-eye mr-1"></i>See My Meetings</a>
                  </div>              
              </div>
              <div class="card-body">
              <form action="<?= base_url().'admin/admin/visitor';?>" name="newadmin" id="newadmin" method="post" enctype="multipart/form-data">
              ...
              <div class='input-group mb-0'>
                ...
                <div class="input-group-append">
                  <button type="button" class="input-group-text" id="ajaxcall">
