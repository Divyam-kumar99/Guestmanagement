            ...
            ?>
                <tbody>
                    ...
                    <td>  
                      ...
                      <select name="status22" id="status<?= $visitor['id'];?>" class="status22" onchange=changestatus(<?=$visitor['id']?>)>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="<?= base_url('admin/employee/reschedule/').$visitor['id']?>" method="post" enctype="multipart/form-data">
